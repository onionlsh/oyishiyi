  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      <img
        ...
        :src="shopInfo.avatar"
      >
      <div class="header-content"  @click="toggleShowShopInfo">
    ...
    <div class="shop-header-discounts" v-if="shopInfo.supports" @click="toggleShowSupport">
    ...
    <!-- 商店详情 transition：添加动画效果 -->
    <transition name="fade">
        <div class="shop-brief-modal" v-show="showShopInfo">
            <div class="brief-modal-content">
                ...
                <span class="iconfont icon-close" @click="toggleShowShopInfo"></span>
                </div>
            </div>
    ...
    <transition name="fade">
        <div class="activity-sheet" v-show="showSupport">
            <div class="activity-sheet-content">
                ...
                <ul class="list" >
                <li class="activity-item" v-for="(support, index) in shopInfo.supports" :key="index" :class="supportClass[support.type]">
                    <span class="content-tag">
...
export default {
    data(){
        return {
            supportClass:['activity-green', 'activity-red', 'activity-orange'], //优惠的样式
            showShopInfo: false,
            showSupport: false
        }
    },
