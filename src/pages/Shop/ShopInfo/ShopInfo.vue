<template>
  <div class="shop-info">
    <div class="info-content">
      ...
      <Split />
      <section class="section" v-if="shopInfo.supports">
        <h3 class="section-title">活动与服务</h3>
        <div class="activity">
          <div class="activity-item" :class="supportClass[support.type]"
      ...
      <Split v-if="shopInfo.pics" />
      <section class="section" v-if="shopInfo.pics">
